          ...
          >
            <div className={`px-6 py-4 ${scrolled ? 'bg-[#313131]' : 'bg-black/30 backdrop-blur-lg'}`}>
              <nav className="flex flex-col gap-4">
                ...
                <a
                  href="tel:+842363656293"
                  className="text-sm font-medium transition-colors duration-300 text-white hover:text-[#8BC349]"
                >
                  📞 +84 236 3656 293
                </a>
              </nav>
      ...
      <section id="gallery" className="relative bg-[#FBF9F5] px-4 sm:px-6 py-12 md:py-[50px]">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
            {[
              { image: '/Gallery/our-team.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951681_dc82feda25b931da33c186e4775a876a.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951689_a9bb9b200bfefe74bb40bcdcb30171a4.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951690_6946a2a91081121ef1c9499bf377ae3e.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951691_08d1e907bd987e15d7b0c2aaab43c816.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951692_212039010cad8b0fbf5acfa77abd7935.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951693_0e95bd507d758120f3b6b45400b34ffb.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951695_1c51801fda94f99b01385cf45e2c5bcc.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951696_5480932213d3525f3eafb9810e516052.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951697_bdade8cb1694fcf6b94552e2039b3007.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951698_40065acf1e264cc89c520260bc49cef1.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951699_a6d2f40058b43f615a9e613122d0d494.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951700_045b2ce4e709d3865ea83dedf61e8cdb.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951701_8b6828f51fd03c0f0fac9d9dc50276b5.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951702_93a4db814c0bd5f24b485979c740ce90.jpg', title: 'Anis Villa' },
              { image: '/Gallery/z7313973951703_8589f370e9e8bb8c97c8a37b2a06b032.jpg', title: 'Anis Villa' },
            ].map((item, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
            ...
            <div>
              ...
              >
                Tran Huu Duc Street, Hoa Hai Ward, Ngu Hanh Son District, Da Nang City
              </p>
              <a
                href="tel:+842363656293"
                className="mb-2 flex items-center gap-2 hover:text-[#8BC349] transition-colors"
                style={{
                  fontSize: '14px',
                  color: '#3C3B40',
                  fontFamily: '"Barlow", sans-serif',
              ...
              <a
                href="mailto:anisvilla.danang@gmail.com"
                className="flex items-center gap-2 hover:text-[#8BC349] transition-colors"
                style={{
                  fontSize: '14px',
                  color: '#3C3B40',
                  fontFamily: '"Barlow", sans-serif',
            ...
            <div>
              <a
                href="tel:+842363656293"
                className="block mb-3 underline hover:text-[#8BC349] transition-colors"
                style={{
                  fontSize: '14px',
                  color: '#3C3B40',
                  fontFamily: '"Barlow", sans-serif',
              ...
              <a
                href="https://www.google.com/maps/search/?api=1&query=Tran+Huu+Duc+Street+Hoa+Hai+Ward+Ngu+Hanh+Son+District+Da+Nang+City"
                target="_blank"
                rel="noopener noreferrer"
                className="block mb-6 underline hover:text-[#8BC349] transition-colors"
                style={{
                  fontSize: '14px',
                  color: '#3C3B40',
                  fontFamily: '"Barlow", sans-serif',
              ...
              <div className="flex gap-3">
                <a 
                  href="https://www.facebook.com/AnisVilla.dn" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-300 hover:bg-[#8BC349] transition-all"
                  aria-label="Facebook"
                >
                ...
                <a 
                  href="https://www.instagram.com/anisvilla_dn" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-300 hover:bg-[#8BC349] transition-all"
                ...
                <a 
                  href="https://www.tiktok.com/@anisvilla.dn" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-300 hover:bg-[#8BC349] transition-all"
                  aria-label="TikTok"
